...
def indent_log(num=2):
    """
    A context manager which will cause the log output_resized to be indented for any
...
class IndentingFormatter(logging.Formatter):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param add_timestamp: A bool indicating output_resized lines should be prefixed
