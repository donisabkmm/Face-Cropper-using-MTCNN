...
verbose = partial(
    ...
    action='count',
    default=0,
    help='Give more output_resized. Option is additive, and can be used up to 3 times.'
)  # type: Callable[..., Option]
...
no_color = partial(
    ...
    action='store_true',
    default=False,
    help="Suppress colored output_resized",
)  # type: Callable[..., Option]
...
quiet = partial(
    ...
    default=0,
    help=(
        'Give less output_resized. Option is additive, and can be used up to 3'
